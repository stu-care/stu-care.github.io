    ...
    {#if selectedGame}
        ...
        <div class="p-4 mb-8 text-center">
            ...
            <div class="flex items-center gap-4">
                ...
                <span class="bg-[--c-aqua] rounded-full p-2"
                    >({teamA.player.initials})</span
                >
                {#if played}<span
        ...
        <div class="grid grid-cols-2 gap-4 w-4/5">
            <div
                style="--highlight: {teamA.pool.colors
                    .color}; --highlight-alt: {teamA.pool.colors.textColor};"
            >
                <div
                    ...
                    {#if played}
                        <div class="my-4">
                            ...
                            <div class="text-center my-2">
                                {resultA.score} ({resultA.tries} tries)
                            </div>
                            <div class="italic font-bold">Bonus Points:</div>
                            <div class="text-center">
                                {#if resultA.bonus > 0}
                                    {#if resultA.tries >= 4}<div>
                                            4+ Tries
                                        </div>{/if}
                        ...
                        <div class="px-4 my-2">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td
                                        >{teamA.pool.w}:{teamA.pool.d}:{teamA
                                            .pool.l}</td
                                    >
                                </tr>
                                <tr>
            ...
            <div
                style="--highlight: {teamB.pool.colors
                    .color}; --highlight-alt: {teamB.pool.colors.textColor};"
            >
                <div
                    class="text-center font-bold p-4 bg-[--highlight] text-[--highlight-alt] rounded-lg rounded-tl-2xl rounded-br-2xl mb-4"
                >
                ...
                <div class="px-4">
                    {#if played}
                        <div class="my-4">
                            <div class="italic font-bold">Game:</div>
                            <div class="text-center my-2">
                                {resultB.score} ({resultB.tries} tries)
                            </div>
                            <div class="italic font-bold">Bonus Points:</div>
                            <div class="text-center">
                                {#if resultB.bonus > 0}
                                    {#if resultB.tries >= 4}<div>
                                            4+ Tries
                                        </div>{/if}
                        ...
                        <div class="px-4 my-2">
                            <table>
                                ...
                                <tr>
                                    <td class="pr-4">WDL:</td>
                                    <td
                                        >{teamB.pool.w}:{teamB.pool.d}:{teamB
                                            .pool.l}</td
                                    >
                                </tr>
                                <tr>
