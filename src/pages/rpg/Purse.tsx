				...
				{denominations.map((abbr, index) => (
					<div key={abbr} className="flex flex-row items-center ">
						<input
							...
							className="flex-grow input w-full input-bordered rounded-e-none focus-within:input-primary"
							min="0"
							step={1}
						/>
						<label
							htmlFor={abbr}
							className="flex w-12 last:rounded-e h-full items-center justify-center bg-base-content/50 text-base-100"
						>
							{abbr}
						</label>
						{index > 0 && (
