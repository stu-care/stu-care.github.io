...
export const skillsList: Skills = [
	...
	},
	{
		...
		stats: [["SD"]],
		type: "Static Action",
		description: "Bonus for control of lycanthropy.",
		ref: "RMC2 Tables 11.1 and 11.2",
	},
	{
		name: "Cookery",
	...
	},
	{
		...
		stats: [["IN"]],
		type: "Static Action",
		description: "Bonus to detecting inanimate traps or ambushes.",
	},
	{
		name: "Diagnostics",
		stats: [["IN", "RE"]],
	...
	},
	{
		...
		stats: [["SD", "AG"]],
		type: "Maneuver",
		description: "Bonus for controlled falling maneuvers.",
		ref: "14.14 Secondary Skills, ChL&CaL, pg 63",
	},
	{
		name: "Dowsing",
	...
	},
	{
		...
		stats: [["ME", "RE"]],
		type: "Static Action",
		description: "Bonus for recognizing and identifying herbs.",
	...
	},
	{
		...
		stats: [["RE", "IN"]],
		type: "Static Action",
		description: "Bonus to hide an item from other beings.",
	},
	{
		name: "Horticulture",
		stats: [["RE", "EM"]],
		type: "Static Action",
		description: "Bonus for growing flowers, fruits, fungi, and vegetables.",
	},
	{
	...
	},
	{
		...
		stats: [["IN", "RE"]],
		type: "Static Action",
		description: "Bonus for spotting hidden openings.",
		ref: "RMC2 Tables 11.1 and 11.2",
	},
	{
		name: "Lock Lore",
	...
	},
	{
		...
		type: "Static Action",
		description: "Bonus for speaking and writing magical languages.",
	...
	},
	{
		...
		subtypes: [
			...
			},
			{
				...
				stats: [["SD", "PR"]],
				type: "Static Action",
				description: "Bonus to cause oneself instantaneous and painless death.",
			},
			{
				name: "Healing",
				stats: [["SD", "EM"]],
	...
	},
	{
		...
		stats: [["EM", "ME", "IN"]],
		type: "Static Action",
		description: "Bonus for delivery and caring for newborn babies.",
	},
	{
	...
	},
	{
		...
		stats: [["IN", "SD"]],
		type: "Static Action",
		description: "Bonus for imitating various sounds.",
		ref: "RMC2 Tables 11.1 and 11.2",
	},
	{
		name: "Mimery",
		stats: [["AG", "SD"]],
		type: "Static Action",
		description: "Bonus for imitating various actions.",
		ref: "RMC2 Tables 11.1 and 11.2",
	},
	{
		name: "Mining",
	...
	},
	{
		...
		stats: [["ME", "SD"]],
		type: "Static Action",
		description: "Bonus for recalling information (photographic memory).",
		ref: "RMC2 Tables 11.1 and 11.2",
	},
	{
		name: "Music",
	...
	},
	{
		...
		stats: [["IN", "AG"]],
		type: "Static Action",
		description: "Bonus for painting an object or picture.",
	},
	{
		name: "Perception",
		stats: [["IN", "IN", "RE"]],
		type: "Static Action",
		description: "See General Perception.",
	},
	{
	...
	},
	{
		...
		stats: [["RE", "ME"]],
		type: "Static Action",
		description: "Understanding of force, energy, etc.",
		ref: "3.48 Scientific Skills, FL, pg 11",
	},
	{
		name: "Picking Locks",
		stats: [["IN", "AG"]],
		type: "Static Action",
		description: "Bonus for locking and unlocking locks and similar devices.",
		ref: "3.6 General Skills, ChL&CaL, pg 38",
	},
	{
		name: "Pick Pockets",
	...
	},
	{
		...
		stats: [["AG", "IN"]],
		type: "Maneuver",
		description: "Bonus for sailing maneuvers.",
		ref: "14.14 Secondary Skills, ChL&CaL, pg 64",
	},
	{
	...
	},
	{
		...
		stats: [["RE", "AG"]],
		type: "Static Action",
		description: "Bonus for setting traps. Traps can be lethal or non-lethal.",
	},
	{
		name: "Siege Engineer",
		stats: [["RE", "IN"]],
	...
	},
	{
		...
		stats: [["AG", "SD"]],
		type: "Maneuver",
		description: "Bonus for skating maneuvers.",
	},
	{
		name: "Skiing",
		stats: [["AG", "SD"]],
		type: "Maneuver",
		description: "Bonus for skiing maneuvers.",
		ref: "14.14 Secondary Skills, ChL&CaL, pg 64",
	},
	{
		name: "Skinning",
		stats: [["AG", "IN"]],
		type: "Static Action",
		description: "Bonus for removing, preserving and caring for animal skins.",
	},
	{
		name: "Smithing",
		stats: [["ST", "AG"]],
	...
	},
	{
		...
		stats: [["QU"]],
		type: "Maneuver",
		description: "Bonus increase to one's speed.",
		ref: "RMC2 Tables 11.1 and 11.2",
	},
	{
		name: "Stalk",
	...
	},
	{
		...
		stats: [["EM", "IN"]],
		type: "Static Action",
		description: "See Attunement.",
	},
	{
		name: "Stilt Walking",
		stats: [["ST", "AG"]],
		type: "Maneuver",
		description: "Bonus for maneuvering on stilts.",
		ref: "RMC2 Tables 11.1 and 11.2",
	},
	{
		name: "Stonecrafts",
	...
	},
	{
		...
		stats: [["AG", "SD"]],
		type: "Maneuver",
		description: "Bonus for surfing maneuvers.",
	},
	{
		name: "Surgery",
		stats: [["SD", "EM", "IN"]],
	...
	},
	{
		...
		stats: [["AG", "SD"]],
		type: "Maneuver",
		description: "Bonus for maneuvering along narrow surfaces.",
		ref: "RMC2 Tables 11.1 and 11.2",
	},
	{
		name: "Time Sense",
	...
	},
	{
		...
		stats: [["IN", "RE"]],
		type: "Static Action",
		description: "Bonus for determining the value and quality of a weapon.",
	},
	{
		name: "Weapon Skills",
		stats: [["ST", "AG"]],
