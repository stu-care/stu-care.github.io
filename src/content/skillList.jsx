export const skillsList = [
    ...
    },
    {
        ...
        type: "Maneuver",
        description: `Bonus for playing any one game primarily involving agility, coordination, and motor skills.`,
        ref: "4.3 Secondary Skills, RMC1, pg 47",
    },
    {
    ...
    },
    {
        ...
        stats: [["PR", "EM"]],
        type: "Static Action",
        description: `Bonus for eliciting a sympathetic response from the person being begged to.`,
        ref: null,
    },
    {
        name: "Biochemistry",
        stats: [["IN", "RE"]],
        type: "Static Action",
        description: `Understanding and analysis of basic biochemistry and genetics for the life forms of a specific area.`,
        ref: "3.48 Scientific Skills, FL, pg 11",
    },
    {
        name: "Boat Pilot",
    ...
    },
    {
        ...
        stats: [["RE", "IN"]],
        type: "Maneuver",
        description: `Bonus for using non-weapon implements as a weapon, (e.g., such as a stool as a bash attack, throwing sand into your opponent's eyes, etc). This skill does not apply to normal weapons which are defined under various other skills (weapon skills, yado, martial arts, etc). The attacks under brawling may never exceed small attacks. For example, an attack with a stool would be a small bash attack, a broken bottle slash would be a small talons attack, etc.)`,
        ref: null,
    },
    {
        name: "Bribery",
        stats: [["PR", "RE"]],
        type: "Static Action",
        description: `Bonus for offering a bribe to an official in the proper and unobtrusive manner.`,
        ref: null,
    },
    {
        name: "Camouflage",
        stats: [["RE", "IN"]],
        type: "Static Action",
        description: `Bonus in hiding or concealing an item or another person by using the natural attributes of the surrounding environment.`,
        ref: null,
    },
    {
        name: "Caving",
        stats: [["SD", "RE"]],
        type: "Maneuver",
        description: `Bonus chance of determining the natural course and layout of a cave or cavern (passage or chamber). Bonus when attempting an unassisted maneuver in a cave. Dwarves receive an additional +25 modification to this skill bonus.`,
        ref: "14.14 Secondary Skills, ChL&CaL, pg 63",
    },
    {
        name: "Channeling",
    ...
    },
    {
        ...
        stats: [["ME", "RE"]],
        type: "Static Action",
        description: `Bonus on manipulating and using circles in conjunction with Circles of Power and Circles of Protection spells. Also allows non-magical research in defining, identifying new "Circles" in which to add to his repertoire of circle spells.`,
        ref: null,
    },
    {
        name: "Climbing",
        stats: [["AG"]],
        type: "Maneuver",
        description: `This could range from the ability to climb sheer faces (absurd), through mountain climbing (very hard), to climbing a ladder (easy) through the use of handholds. The normal climbing rate for walls with adequate handholds is 10'/md as a "medium" moving maneuver.`,
    ...
    },
    {
        ...
        stats: [["AG", "SD"]],
        type: "Maneuver",
        description: `Bonus for manipulating one's body in order to move through small openings or absorb sudden crushing impact (other than falls). Helps escape from bonds, etc.`,
        ref: "14.14 Secondary Skills, ChL&CaL, pg 63",
    },
    {
    ...
    },
    {
        ...
        stats: [["AG", "IN"]],
        type: "Maneuver",
        description: `Bonus when attempting to recreate a dance one witnesses. Also used to create new dances, this skill can be a factor in Magic Rituals.`,
        ref: "14.14 Secondary Skills, ChL&CaL, pg 63",
    },
    {
        ...
        stats: [["ME", "RE"]],
        type: "Static Action",
        description: `Bonus for recognizing and identifying the major powers and abilities of extradimensional beings, and things pertaining to demons/devils (land, items, etc.).`,
        ref: null,
    },
    {
        name: "Detect Traps",
    ...
    },
    {
        ...
        stats: [["IN", "RE"]],
        type: "Static Action",
        description: `Bonus for determining which way is north or any specific direction, such as "HOME", without the aid of navigational instruments. Skill is useful for determining direction while underground, during the darkest night without stars, moon, or other night lights.`,
        ref: "RMC2 Tables 11.1 and 11.2",
    },
    {
        ...
        stats: [["AG"]],
        type: "Maneuver",
        description: `Bonus to remove a foe's weapon with your own. If successful, the opponent must make a successful RR vs. the level (# of skill ranks) of disarming skill used. There are 4 categories for the user to develop. The first is the primary skill, and the others can be used as similar skills at a 1/2 skill rank bonus. Each category reflects the type of weapon that the disarmer can go against. Categories: 1 Handed, 2 Handed, Polearm, and Two Weapon Combo.`,
        ref: "4.3 Secondary Skills, RMC1, pg 48",
    },
    {
    ...
    },
    {
        ...
        stats: [["IN", "AG"]],
        type: "Static Action",
        description: `Bonus in identifying and disarming, but not locating, an inanimate trap.`,
        ref: "3.6 General Skills, ChL&CaL, pg 38",
    },
    {
        name: "Disguise",
        stats: [["PR", "SD"]],
        type: "Static Action",
        description: `Bonus to change one's appearance (not his actual shape or weight) by application of cosmetics and other props.`,
        ref: null,
    },
    {
        ...
        stats: [["CO"]],
        type: "Maneuver",
        description: `Bonus is added to the character's base exhaustion points to determine his total exhaustion points for movement purposes.`,
        ref: null,
    },
    {
        name: "Divination",
    ...
    },
    {
        ...
        stats: [["EM"]],
        type: "Static Action",
        description: `Bonus for locating underground water sources through the ground. The water will be directly under your feet when the skill has successfully been used.`,
        ref: null,
    },
    {
        name: "Drafting",
        stats: [["RE", "ME"]],
        type: "Static Action",
        description: `Bonus to draw an item, object, blueprints, etc. This is not freehand drawing; specialized drafting equipment (squares, triangles, compasses, etc.) is used in making accurate and precise drawings (normally to scale).`,
        ref: null,
    },
    {
        name: "Dragon Lore",
        stats: [["ME", "RE"]],
        type: "Static Action",
        description: `Bonus for recognizing and identifying the major powers and abilities of dragons, and things pertaining to dragons (e.g., lands, items).`,
        ref: null,
    },
    {
        name: "Driving",
        stats: [["AG", "QU"]],
        type: "Maneuver",
        description: `As in Riding, skill ranks in driving must be developed separately for different types of vehicles. Vehicles are defined as animals pulling such objects as wagons, carts, sleighs, etc. One skill rank allows basic understanding of the controls; subsequent ranks reflect increased ability and some quickness in maneuvers.`,
        ref: null,
    },
    {
        name: "Drug Tolerance",
        stats: [["CO", "SD"]],
        type: "Static Action",
        description: `Bonus for resisting the effects of any one type of intoxicant, poison, or other chemical substances. Bonus is applied directly to the RR. Skill must be developed separately for each type of drug (e.g., alcohol, sodium pentothal). One need not be conscious to have the bonus.`,
        ref: "3.5 Secondary Skills, FL, pg 12",
    },
    {
        name: "Duping",
        stats: [["PR"]],
        type: "Static Action",
        description: `Bonus for speaking quickly, convincingly, and confusingly in order to get a victim to do something they would not ordinarily do. This skill is normally used on one person at a time.`,
        ref: null,
    },
    {
        name: "Engineering",
        stats: [["RE", "ME"]],
        type: "Static Action",
        description: `Bonus for knowing major facts about engineering of the appropriate technical level known to the culture. Similar to 1 tech level forward in time and 1 tech level/skill rank back in time.`,
        ref: null,
    },
    {
        name: "Faerie Lore",
        stats: [["ME", "RE"]],
        type: "Static Action",
        description: `Bonus for recognizing and identifying the major powers and abilities of faeries, and things pertaining to faeries (e.g., lands, items, etc.).`,
        ref: null,
    },
    {
        name: "Falsification",
    ...
    },
    {
        ...
        stats: [["AG", "SD"]],
        type: "Static Action",
        description: `Bonus for making an arrow out of available wood, metal, paper, and/or feathers. Note: With this skill, sophisticated types of special purpose arrows may be crafted (such as hunting, armor-piercing, message, howling, poison-bearing, etc).`,
        ref: "14.14 Secondary Skills, ChL&CaL, pg 63",
    },
    {
        name: "Flora Lore",
    ...
    },
    {
        ...
        stats: [["AG"]],
        type: "Maneuver",
        description: `Bonus for flying or gliding through the use of natural or artificial wings. Flying/gliding has a natural -75 for all types of maneuvers performed while trying to fly/glide if this skill is not learned or developed (e.g., feathered wings, parachute, hang-glider, balloonist, etc). Does not include powered aircraft of any type.`,
        ref: null,
    },
    {
        name: "Foraging",
    ...
    },
    {
        ...
        stats: [["ME", "PR", "IN"]],
        type: "Static Action",
        description: `Bonus when playing any game with a significant element of luck. Also includes cheating as a form of improving one's luck at any game.`,
        ref: "14.14 Secondary Skills, ChL&CaL, pg 63",
    },
    {
    ...
    },
    {
        ...
        stats: [["AG"]],
        type: "Maneuver",
        description: `Bonus when throwing a grappling hook and making it stick at the intended targeted area. The hook can be thrown up to 20 feet horizontally and 10 feet vertically per skill rank learned (strength mods apply).`,
    ...
    },
    {
        ...
        stats: [["ME", "RE"]],
        type: "Static Action",
        description: `Bonus for designing or recognizing a particular heraldic crest (coats-of-arms). Separate cultures must be developed separately.`,
        ref: "4.3 Secondary Skills, RMCJ, pg 48",
    },
    {
        name: "Herb Lore",
    ...
    },
    {
        ...
        stats: [["EM", "PR"]],
        type: "Static Action",
        description: `Bonus for gathering, befriending, or manipulating herd animals. Skill normally deals with one group of animals at a time.`,
        ref: "14.14 Secondary Skills, ChL&CaL, pg 63",
    },
    {
        name: "Hide Item",
    ...
    },
    {
        ...
        stats: [["QU", "AG"]],
        type: "Maneuver",
        description: `Bonus for performing an Iai attack draw. The skill of Iai is a quick-draw technique to get a weapon from scabbard into battle very quickly. Iai normally is only used with bladed weapons. If the user rolls 101+ (1-100 open-ended roll plus the skill bonus), the weapon is out of the scabbard and in hand and moreover may make an attack and/or move the same round without the normal -20 penalty for drawing a weapon. The user will make an additional roll for his attack. However, if the roll is negative, he has dropped the weapon. Otherwise, if the Iai is unsuccessful, he takes the normal -20 for drawing a weapon.`,
        ref: "4.3 Secondary Skills, RMC1, pg 48",
    },
    {
        name: "Interrogation",
    ...
    },
    {
        ...
        stats: [["AG", "IN"]],
        type: "Maneuver",
        description: `Bonus for tossing up objects and manipulating them in such a manner as to keep them up in the air.`,
        ref: "RMC2, Tables 11.1 and 11.2",
    },
    {
        name: "Jumping",
        stats: [["ST", "AG"]],
        type: "Maneuver",
        description: `Bonus for jumping maneuvers either running or from a standing position.`,
        ref: "RMC2, Tables 11.1 and 11.2",
    },
    {
        name: "Lancing",
        stats: [["ST", "AG"]],
        type: "Maneuver",
        description: `Bonus for using complex Lancing (mounted) maneuvers, such as tilting, skewering rings in a tourney, etc.`,
        ref: null,
    },
    {
        name: "Leadership",
        stats: [["PR"]],
        type: "Static Action",
        description: `Bonus to inspire and command others to follow you, and to make others believe that you are competent to lead and that you know what you are doing. This includes the ability to raise the morale of those you command.`,
        ref: null,
    },
    {
    ...
    },
    {
        ...
        stats: [["IN", "RE"]],
        type: "Static Action",
        description: `Bonus for determining if one is being lied to. Acting skill on the part of the liar is a negative modifier.`,
        ref: null,
    },
    {
        name: "Linguistics",
    ...
    },
    {
        ...
        stats: [["EM", "RE"]],
        type: "Static Action",
        description: `Bonus for packing loads and placing them on pack animals to ensure safe passage of the loads and to reduce the stress and strain on the pack animals. Loading must be learned as a separate skill for each type of animal that the individual uses as a pack animal.`,
        ref: null,
    },
    {
    ...
    },
    {
        ...
        stats: [["ME", "RE"]],
        type: "Static Action",
        description: `Bonus for recognizing and identifying major forms of locks and similar devices. Bonuses for knowing the type of lock encountered are given in 15.32 Static Action Table.`,
    ...
    },
    {
        ...
        stats: [["RE", "ME"]],
        type: "Static Action",
        description: `Bonus for using and making maps. This skill is also used for surveying.`,
        ref: null,
    },
    {
        name: "Mechanition",
        stats: [["RE", "AG"]],
        type: "Static Action",
        description: `Bonus for building and using a machine that already exists. It will be necessary to have the appropriate skills to build the machine. Each type of machine must be learned as a separate skill.`,
        ref: null,
    },
    {
        name: "Meditation",
        stats: [["PR", "SD"]],
        type: "varies",
        description: `Bonus for entering, leaving, and exploiting meditative trances. Physical prodding allows one to make a static maneuver to leave trance, as does a painful strike (modify by +25). Elves receive an additional +25 modification to this skill bonus. The following are subforms of this skill and each must be developed separately (they can be used as similar skills with a 1/2 bonus).`,
        ...
        subtypes: [
            ...
            },
            {
                ...
                stats: [["SD", "EM"]],
                type: "Static Action",
                description: `Bonus for increasing one's healing rate. The individual using this skill goes into a coma. Healing rate is increased/decreased by the amount the skill bonus roll over 100 as a percentage times the racial healing rate.`,
                ref: null,
            },
            {
                name: "Ki",
                stats: [["SD", "PR"]],
                type: "Static Action",
                description: `Bonus for achieving a special +25 bonus on any activity attempted using concentration and the focusing of internal reserves. If the user rolls 101+ (1-100 open-ended roll plus the skill bonus), +25 is added to any such activity the next round. However, this roll requires 75% of the user's activity the round it is attempted.`,
                ref: "4.3 Secondary Skills, RMC1, pg 48",
            },
            {
                name: "Sleep",
                stats: [["SD", "IN"]],
                type: "Static Action",
                description: `Bonus for decreasing the amount of time one needs to fully recover. The sleep time is increased/decreased by the amount of the skill bonus roll over 100 as a percentage times racial sleep requirement.`,
                ref: null,
            },
            {
                name: "Trance",
                stats: [["PR", "SD"]],
                type: "Static Action",
                description: `Bonus for an individual entering, leaving and exploiting a mental trance which the individual can use to help solve difficult problems, increase his chance to successfully cast a spell, aiding in attunement rolls, etc. (subject to GM stipulation).`,
                ref: null,
            },
        ],
    },
    {
        ...
        stats: [["IN", "RE"]],
        type: "Static Action",
        description: `Bonus for determining the value and quality of metal objects in worked, refined or raw condition.`,
        ref: null,
    },
    {
        name: "Metal Lore",
        stats: [["ME", "RE"]],
        type: "Static Action",
        description: `Bonus for recognizing and identifying metals, alloys, metallic crystal structures, etc. Also will give information on famous, magical artifacts, historic, legendary, or cursed types of metals. Skill lore is developed separately for each culture or region as applicable to the GM's world scheme.`,
        ref: null,
    },
    {
        name: "Midwifery",
    ...
    },
    {
        ...
        stats: [["IN", "AG"]],
        type: "Maneuver/OB",
        description: `This skill bonus is part of the total combat OB applied when using catapults, trebuchets, ballistae, or other missile artillery. Each weapon must be learned as a separate skill. One third similar skill bonus may be used on all unlearned artillery types.`,
        ref: null,
    },
    {
        name: "Mnemonics",
    ...
    },
    {
        ...
        stats: [["AG", "EM"]],
        type: "Static Action",
        description: `Bonus for writing music language which other musicians can understand and use. (**Note:** This is a specialized written linguistic skill; linguistic guidelines apply.)`,
    ...
    },
    {
        ...
        stats: [["ME", "RE"]],
        type: "Static Action",
        description: `Bonus for recognizing and identifying major aspects of philosophy or religious doctrines. Each philosophy/religious doctrine may be concentrated in and learned separately for in-depth knowledge and understanding.`,
        ref: null,
    },
    {
        name: "Physics",
    ...
    },
    {
        ...
        stats: [["AG", "IN"]],
        type: "Static Action",
        description: `Bonus for picking pockets. If successful, the contents are lifted and the skill bonus is applied against the victim's perception.`,
        ref: "Trickery",
    },
    {
        name: "Planetology",
        stats: [["RE", "EM"]],
        type: "Static Action",
        description: `A general science embracing the fields of geologic, meteorological, and geographic analysis in a planet-wide context, concentrating on sweeping environmental systems.`,
        ref: "3.48 Scientific Skills, FL, pg 11",
    },
    {
        ...
        stats: [["AG", "ME"]],
        type: "Static Action",
        description: `Bonus for playing an instrument. There are three major divisions of instruments: Strings, Winds, and Percussions. When this skill is selected to be developed, the major division must be assigned at this point. (e.g., Strings as #1 selection, Percussions as #2 selection, and Winds as #3 selection). Each instrument within each division must be learned as a separate skill. Similar type instruments may warrant "similar" skill consideration. There is no similar skill rule between major play instrument divisions.`,
        ref: null,
    },
    {
        ...
        stats: [["IN", "RE"]],
        type: "Static Action",
        description: `Bonus for composing a poem. Must have 4 skill ranks in the language the poem is being written in with a +10 bonus if the composer has 7 ranks or more in the language. Elves get a +10 bonus.`,
    ...
    },
    {
        ...
        stats: [["ME", "RE"]],
        type: "Static Action",
        description: `Bonus for recognizing and identifying poisons, as well as knowledge of proper application and usage techniques. (These may require an agility roll to actually carry through.)`,
    ...
    },
    {
        ...
        stats: [["IN", "RE"]],
        type: "Static Action",
        description: `Bonus for perceiving the presence of poison in/on an item or object.`,
        ref: null,
    },
    {
        name: "Pole Vaulting",
        stats: [["ST", "AG"]],
        type: "Maneuver",
        description: `Bonus for handling a pole to surmount or cross over an obstacle.`,
        ref: "RMC2 Tables 11.1 and 11.2",
    },
    {
        ...
        stats: [["EM"]],
        type: "Static Action",
        description: `Bonus for seeing active Essence (blue), Channelling (red), and Mentalism (green) magics. If the GM allows players to develop the skill of Power Perception he should stipulate that Detect Magic spells will detect Magic, active or inactive (e.g., waiting spells).`,
        ref: null,
    },
    {
    ...
    },
    {
        ...
        stats: [["IN", "EM"]],
        type: "Static Action",
        description: `Influencing others through indirect means, rather than direct speech. Includes such ideas as starting rumors, as well as designing large campaigns.`,
        ref: "3.5 Secondary Skills, FL, pg 12",
    },
    {
        ...
        stats: [["ME", "IN"]],
        type: "Static Action",
        description: `Bonus for perceiving the use of psionics. Individuals who use this skill must possess psionic skills and abilities.`,
        ref: "FL",
    },
    {
        ...
        stats: [["EM", "PR"]],
        type: "Static Action",
        description: `Bonus for impressing, entertaining, or manipulating groups of people directly.`,
        ref: "14.14 Secondary Skills, ChL&CaL, pg 64",
    },
    {
        name: "Racial History",
    ...
    },
    {
        ...
        stats: [["AG"]],
        type: "Maneuver",
        description: `Bonus to rapidly descend from a height. If the rappelling roll is unsuccessful, the individual has a chance of falling. Rappelling rate is equal to the individual's normal movement rate: walk +0, fast walk/jog -10, run -20, fast run/sprint -30, fast sprint -40, dash -50. Negative modifiers due to speed apply.`,
        ref: null,
    },
    {
        name: "Read Tracks",
...

    {
        ...
        stats: [["RE", "ME"]],
        type: "Static Action",
        description: `Bonus for knowing the ins and outs of an area or region. Each different type of region must be developed as a separate skill (e.g., mountain zone, jungle zone, large city, etc). See Region/Climates List, Section 4.6.`,
        ref: null,
    },
    {
        name: "Reverse Stroke",
        stats: [["AG", "RE"]],
        type: "Maneuver",
        description: `Bonus for applying one's melee OB against an opponent to one's flank or rear without turning or changing position. In such a situation, the applicable OB is the normal OB times this skill bonus as a percentage (e.g., a normal OB of +70 and a skill bonus of 60 would result in a +42 Reverse Stroke OB). The resulting OB may never exceed the normal OB.`,
    ...
    },
    {
        ...
        description: `Bonus proficiency in knot recognition, knot-tying, braiding, and splicing, or when making a maneuver while suspended from a rope or analogous flexible line, or when throwing a line. Allows one half skill ranks in grappling hook.`,
        ref: "14.14 Secondary Skills, ChL&CaL, pg 64",
    },
    {
        name: "Rowing",
        stats: [["ST", "SD"]],
        type: "Maneuver",
        description: `Bonus for self-powered boat maneuvers, including rowing, poling, etc.`,
        ref: "14.14 Secondary Skills, ChL&CaL, pg 64",
    },
    {
        name: "Runes",
    ...
    },
    {
        ...
        stats: [["ME", "EM"]],
        type: "Static Action",
        description: `Bonus for recognizing and identifying major insanities (including manias, phobias, depressions, dementia, etc.) and attempting to heal or correct them. Must be developed either in-depth for a specific race or in general trends of multi-cultural racial makeups. Several races may be developed simultaneously provided research materials are available.`,
        ref: "RMC2 Tables 11.1 and 11.2",
    },
    {
        name: "Sculpting",
        stats: [["IN", "AG"]],
        type: "Static Action",
        description: `Bonus for making of 3D art forms through molding of malleable material or the carving of hard material.`,
        ref: null,
    },
    {
        name: "Scrounge",
        stats: [["IN", "RE"]],
        type: "Static Action",
        description: `Bonus in being able to come up with the location of a particular needed item, part or ingredient. This skill is normally used in an urban type of setting. This does not cover locating of food or water.`,
        ref: "See Foraging",
    },
    {
        name: "Second Aid",
        stats: [["SD", "EM", "IN"]],
        type: "Static Action",
        description: `Bonus for performing minor surgery, which includes sewing closed wounds, removing diseased or mangled limbs, bone setting, and any other simple minor surgery operation.`,
        ref: null,
    },
    {
        name: "Seduction",
        stats: [["EM", "PR"]],
        type: "Static Action",
        description: `Bonus when attempting to emotionally, sensually, or sexually manipulate someone.`,
        ref: "14.14 Secondary Skills, ChL&CaL, pg 64",
    },
    {
        ...
        stats: [["IN", "RE"]],
        type: "Static Action",
        description: `Bonus to detect animate traps, ambushes, or assassinations in progress. Range is 10' per skill rank known.`,
        ref: "RMC2 Tables 11.1 and 11.2",
    },
    {
        ...
        stats: [["IN", "EM"]],
        type: "Static Action",
        description: `Bonus to determine if the natural order or reality has or is going through turmoil (e.g., Demonic Gate opening or closing, power fluctuation which is disturbing or causing the fabric of this dimension to shift, holes in the space-time continuum, etc).`,
        ref: "RMC2 Tables 11.1 and 11.2",
    },
    {
        name: "Set Traps",
    ...
    },
    {
        ...
        stats: [["ME", "SD"]],
        type: "Static Action",
        description: `Bonus when using any form of signal communications. This skill is a specialized form of linguistics and linguistics guidelines apply.`,
        ref: "14.14 Secondary Skills, ChL&CaL, pg 64",
    },
    {
        name: "Singing",
        stats: [["PR", "IN"]],
        type: "Static Action",
        description: `Bonus for attempts to mimic tunes and vocalized notes. This skill is a specialized form of linguistics and linguistics guidelines apply.`,
        ref: "14.14 Secondary Skills, ChL&CaL, pg 64",
    },
    {
        name: "Silent Kill",
        stats: [["AG", "IN"]],
        type: "Maneuver",
        description: `Bonus for attempting to kill an opponent silently. If successful, the opponent cannot cry out or sound an alarm. This skill does not include the approach to the opponent, and is rolled prior to the attack roll.`,
        ref: null,
    },
    {
        name: "Skating",
    ...
    },
    {
        ...
        stats: [["AG"]],
        type: "Maneuver",
        description: `Stalking is the ability to move using silence, camouflage, and shadows to conceal your presence.`,
        ref: "3.6 General Skills, ChL&CaL, pg 38",
    },
    {
        name: "Hiding",
        stats: [["SD"]],
        type: "Static Action",
        description: `Hiding is the ability to stay using silence, camouflage, and shadows to conceal your presence.`,
        ref: "3.6 General Skills, ChL&CaL, pg 38",
    },
    {
        name: "Star-Gazing",
        stats: [["ME", "IN"]],
        type: "Static Action",
        description: `Bonus chance of determining dates, directions, and locations when the stars are visible. Provides an ideal complement to one's navigation skills. Must be developed separately for each planet/dimension; otherwise bonus is halved for all but the specific planet/dimension researched.`,
        ref: "14.14 Secondary Skills, ChL&CaL, pg 64",
    },
    {
    ...
    },
    {
        ...
        stats: [["IN", "RE"]],
        type: "Static Action",
        description: `Bonus for determining the value and quality of stone objects in worked, refined, or raw condition. This skill is also used to evaluate gems.`,
        ref: null,
    },
    {
        name: "Stone Lore",
        stats: [["ME", "RE"]],
        type: "Static Action",
        description: `Bonus for recognizing and identifying stones. Also will give information on famous, magical, powerful, historic, legendary, or cursed types of stone. Skill lore is developed separately for each culture or region as applicable to GM's world scheme.`,
        ref: null,
    },
    {
        name: "Street Wise",
        stats: [["PR", "IN"]],
        type: "Static Action",
        description: `Awareness of events in the underworld and the ability to make contacts with the characters who run and live in the underworld society.`,
        ref: null,
    },
    {
    ...
    },
    {
        ...
        stats: [["SD", "EM", "IN"]],
        type: "Static Action",
        description: `Bonus for performing major surgery, which includes performing exploratory surgery, organ transplants, acupuncture, and organ and limb repairs. Use of this skill is done with simple equipment (e.g., scalpel, anesthesia, hemostats, respirators, etc).\n\n**Option:** Must be developed separately for exploratory, organ transplants, limb repair, organ repair, etc.`,
        ref: null,
    },
    {
        name: "Surveillance",
        stats: [["IN", "SD"]],
        type: "Static Action",
        description: `Bonus for keeping watch over a person, place, or object. Also includes the ability to determine the best approach and technique in solving a crime.`,
        ref: null,
    },
    {
        name: "Swimming",
    ...
    },
    {
        ...
        stats: [["RE", "ME"]],
        type: "Static Action",
        description: `Bonus for playing games which contain very little chance element, such as Chess or Go. Skills for different games must be developed separately, but normally if the player develops more than one game, he may receive bonuses for similar games as for similar weapons.`,
    ...
    },
    {
        ...
        stats: [["PR", "ME"]],
        type: "Static Action",
        description: `Bonus for reciting stories. The skill rank number equals the number of tales that you have committed to memory. GMs may wish to assign names to each of these tales and the search for new tales could lead to possible adventures.`,
        ref: null,
    },
    {
    ...
    },
    {
        ...
        stats: [["IN", "ME"]],
        type: "Static Action",
        description: `Bonus for determining the time of day or how much time has passed over a specific time period.`,
        ref: null,
    },
    {
        name: "Tracking",
        stats: [["IN", "RE"]],
        type: "Static Action",
        description: `Bonus for tracking maneuvers and following a trail left by someone or something such as footprints, broken branches, crushed grass, hanging pieces of cloth. The skill Read Tracks gives the tracker the significant details of the tracks.`,
    ...
    },
    {
        ...
        stats: [["RE", "EM"]],
        type: "Static Action",
        description: `Bonus for transactions involving a bargained exchange of money or goods, particularly with respect to rolls on purchase or resale price charts found in RoleMaster.`,
        ref: "14.14 Secondary Skills, ChL&CaL, pg 65",
    },
    {
        name: "Trade Lore",
        stats: [["ME", "RE"]],
        type: "Static Action",
        description: `Bonus for recognizing and identifying major products and business distribution patterns (e.g., if you buy this and take it over there can it be sold for a profit).`,
        ref: null,
    },
    {
    ...
    },
    {
        ...
        stats: [["RE", "EM"]],
        type: "Static Action",
        description: `Allows building traps out of available resources. The bonus of the trap-maker may subtract from any detection rolls, depending on location, care and time in construction, and trap type.`,
        ref: "14.14 Secondary Skills, ChL&CaL, pg 65",
    },
    {
        name: "Trickery",
        stats: [["PR", "QU"]],
        type: "Maneuver",
        description: `Bonus for any maneuvers involving sleight of hand, confusing sight tricks, and sleight-of-hand diversions.\n\n**Option:** Make pick pockets a separate skill with the same cost as trickery. See Pick Pockets.`,
        ref: "14.14 Secondary Skills, ChL&CaL, pg 65",
    },
    {
        name: "Tumbling",
        stats: [["AG", "SD"]],
        type: "Maneuver",
        description: `Bonus for horizontal dives, rolling, vaulting maneuvers, or swinging on stationary objects. Also used to decrease the damage one takes from a fall. A character could fall safely up to 1'/skill bonus point if a successful maneuver roll is made.`,
        ref: "14.14 Secondary Skills, ChL&CaL, pg 65",
    },
    {
    ...
    },
    {
        ...
        stats: [["AG", "QU"]],
        type: "Maneuver",
        description: `Bonus for evading an attack by using a tumbling maneuver. The skill rank (NOT the skill rank bonus) is added to the DB. This skill is rolled for during the round that the skill is actively used. An individual may not parry, use a shield, or attack while using this skill.`,
        ref: null,
    },
    {
    ...
    },
    {
        ...
        stats: [["AG", "IN"]],
        type: "Static Action",
        description: `Bonus for handling, caring, and storing of poisons. Allows the individual to poison without accidentally poisoning himself or rendering the poison useless.`,
        ref: null,
    },
    {
        name: "Ventriloquism",
        stats: [["SD", "IN"]],
        type: "Static Action",
        description: `Bonus for throwing one's voice so that it seems to originate from a point of the ventriloquist's choice. Range is approximately equal to 5'/skill rank.`,
        ref: null,
    },
    {
        name: "Warding Lore",
        stats: [["ME", "RE"]],
        type: "Static Action",
        description: `Bonus on manipulating and using wards in conjunction with the appropriate ward spells. Also allows non-magical research in defining and identifying new "Wards" in which to add to the repertoire of ward spells.`,
        ref: null,
    },
    {
        ...
        stats: [["IN", "EM"]],
        type: "Static Action",
        description: `Bonus chance of determining local weather for the next 24 hours.`,
        ref: "14.14 Secondary Skills, ChL&CaL, pg 65",
    },
    {
